...
given your operation, what do you need?

what can you do with it


how do calc the data
list ou customer (walkthrough/example)
wednsday (comercial guys)


slide abouht rulesplaybook verus specific actions
channel simmilar / reommendation systems


## how to organize agents

### types of digital assets
- large: data, binaries, media 
- note: plain text/markdown
- office: doc, ppt, pdf, csv (small) and images
	


### The Vault
Single place for non-code text and small midia/data