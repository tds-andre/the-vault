# Alex — Tasks
*Alex's capability registry. Each task defines a common attribution — what it is, when to use it, and how to execute it.*
*Living document — add tasks as recurring patterns emerge.*

---

## Task: Set Up MCP Server
...
4. Note the fix and root cause in `memory.md` if it's likely to recur

---

## Task: Tool Evaluation
...
4. Note the decision and rationale in `memory.md`
